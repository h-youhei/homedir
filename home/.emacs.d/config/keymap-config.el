...
(let ((nmap evil-normal-state-map)
  ...
  (define-key vmap (kbd "C-e") #'load-yas-visual-expand)
  ...
  (with-eval-after-load 'yasnippet
    ...
    (let ((map yas-minor-mode-map))
      ...
      (evil-define-key 'visual map (kbd "C-e") #'yas-visual-expand)
    ...
    (let ((map yas-keymap))
      ...
      ;; (define-key map (kbd "C-e") #'yas-expand)
      (define-key map (kbd "C-j") #'yas-next-field)
      (define-key map (kbd "C-S-j") #'yas-prev-field)
